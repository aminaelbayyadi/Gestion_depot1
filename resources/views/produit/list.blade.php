            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tr valign="middle">
                        ...
                        <td>
                            <a href="{{ route('produits.edit',$produit->idproduit) }}" class="btn btn-primary btn-sm">Edit</a>
                            <a href="#" onclick="deleteproduit({{ $produit->idproduit }})" class="btn btn-danger btn-sm">Delete</a>
